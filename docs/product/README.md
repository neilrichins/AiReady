...
This directory contains project-neutral Markdown boilerplate for approved product intent and requirements. Its location is an example within AiReady, not a required structure for adopting projects.

Use the [adoption map](../boilerplate/ADOPTION_MAP.md) before creating new records. If equivalent information already has an authoritative home, adapt the relevant sections there instead of duplicating it.
...
- Update affected feature, verification, risk, roadmap, and release records when product requirements change.
